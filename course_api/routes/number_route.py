...
from schemas import Number, NumbersToSum, Result, Detail
...
@router.get(
    ...
    responses={
        status.HTTP_200_OK: {"model": Number},
        status.HTTP_500_INTERNAL_SERVER_ERROR: {"model": Detail},
    },
    summary="Get a number, or not!",
)
def get() -> Number:
